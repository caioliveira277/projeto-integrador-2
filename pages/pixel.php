    ...
    <section class="container-xl px-0 px-lg-2">
        ...
        <article class="position-relative banner-1 mt-5">
            ...
            <div class="ml-sm-auto col-12 col-sm-7 col-lg-6 bg-opacidade px-0 p-lg-4">
                <img src="./assets/images/pixel/celeste-sm.webp" class="d-block img-fluid d-sm-none" alt="Cena do jogo 171, um personagem atirando contra um carro em meio a rua">
        ...
        <article class="position-relative banner-2 mt-5 mb-4">
            ...
            <div class="ml-sm-auto col-12 col-sm-7 col-lg-6 bg-opacidade px-0 p-lg-4">
                <img src="./assets/images/pixel/chroma-squad-sm.webp" class="d-block img-fluid d-sm-none" alt="Cena do jogo Rio, um personagem em frente a uma pedra com uma frase escrita">
