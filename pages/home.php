<main class="pagina-home container">
    ...
    <div class="row d-flex justify-content-center align-items-center form-email-contact">
        ...
        <div class="col-lg-4 col-md-8 col-sm-6 p-2 text-center">
            ...
            <label for="send" class="btn btn-primary p-0 d-flex justify-content-center align-items-center button-send-mail">
                <span class="m-2">
                    <img id="sendmail" src="./assets/icons/sendmail.svg" alt="Icone de carta representando o envio de uma mensagem">
                </span>
