<main class="pagina-home container">
    ...
    <div class="row autor-postagem pt-5 mt-3">
        <figure class="col-lg-6 col-sm-12 d-flex justify-content-md-start justify-content-sm-center">
            <img src="./assets/images/alex.png" class="rounded-circle img-perfil mr-3" alt="">
            <figcaption>
                <div class="d-flex">
    ...
    <div class="row">
        <div class="col-12">
            <img class="img-fluid" src="./assets/images/banner_home.jpg" alt="Um homem utilizando seu computador">
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-3 d-flex align-items-center reacoes p-4">
            <img class="m-1" src="./assets/icons/like.svg">
            <p class="m-1">12k</p>
            <img class="m-1" data-toggle="modal" data-target="#modalExemplo" src="./assets/icons/comentarios.svg">
            <p class="m-1">39</p>
            <img class="m-1" src="./assets/icons/save.svg">
            <p class="m-1">Salvar</p>
        </div>
    </div>
    ...
    <div class="row d-flex justify-content-center align-items-center form-email-contact">
        ...
        <div class="col-lg-4 col-md-8 col-sm-6 p-2 text-center">
            ...
            <label for="send" class="btn btn-primary p-0 d-flex justify-content-center align-items-center button-send-mail"><span class="m-2"><img id="sendmail" src="./assets/icons/sendmail.svg"></span>Aceito Receber Novidades</label>
