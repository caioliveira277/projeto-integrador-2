<main class="acao-aventura bg-preto pb-5">
    <section class="container-xl px-0 px-lg-2">
        <div class="d-flex flex-column justify-content-center banner-postagem px-3">
            <em class="text-center m-auto">
                <h1 class="titulo-sombreado">JOGOS DE AÇÃO E AVENTURA</h1>
                <h2 class="mt-4 subtitulo-opacidade">Grandes clássicos para reunir o squad e partir para cima </h2>
            </em>
            <div class="row justify-content-around mb-5 flex-column flex-md-row align-items-center align-items-md-center p-3 bg-botoes-navegacao">
                <a href="./index.php?view=rpg" class="btn btn-outline-warning rounded-pill px-5 my-2 my-md-0 col-12 col-md-4 font-weight-bold w-customizado">RPG</a>    
                <a href="./index.php?view=terror" class="btn btn-outline-warning rounded-pill px-5 my-2 my-md-0 col-12 col-md-4 font-weight-bold w-customizado">TERROR</a>    
                <a href="./index.php?view=pixel" class="btn btn-outline-warning rounded-pill px-5 my-2 my-md-0 col-12 col-md-4 font-weight-bold w-customizado">PIXEL</a>    
            </div>
        </div>
        <article class="position-relative banner-1 mt-5">
            ...
            <div class="ml-sm-auto col-12 col-sm-7 col-lg-6 bg-opacidade px-0 p-lg-4">
                <img src="./assets/images/acao/171-sm.webp" class="d-block img-fluid d-sm-none" alt="Cena do jogo 171, um personagem atirando contra um carro em meio a rua">
        ...
        <article class="position-relative banner-2 mt-5 mb-4">
            ...
            <div class="ml-sm-auto col-12 col-sm-7 col-lg-6 bg-opacidade px-0 p-lg-4">
                <img src="./assets/images/acao/rio-sm.webp" class="d-block img-fluid d-sm-none" alt="Cena do jogo Rio, um personagem em frente a uma pedra com uma frase escrita">
