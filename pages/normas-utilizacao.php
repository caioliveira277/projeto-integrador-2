<main>
	<section class="container">
		...
		<div class="row mt-5">
			...
			<div class="col-sm-6 bg-light mt-3" id="perguntasFrequentes2" data-children=".pergunta">
				<h4 class="display-5 text-center mt-3">Quais são minhas responsabilidades ?</h4>
				<div class="pergunta py-2">
					<a class="lead" data-toggle="collapse" data-parent="#perguntasFrequentes2" href="#pergunta5" aria-expanded="true" aria-controls="pergunta5">Posso copiar a notícia e modificar ?</a>
				...
				<div class="dropdown-divider"></div>
				<div class="pergunta py-2">
					<a class="lead" data-toggle="collapse" data-parent="#perguntasFrequentes2" href="#pergunta6" aria-expanded="true" aria-controls="pergunta6">Posso usar as fotos para meu produto ?</a>
				...
				<div class="dropdown-divider"></div>
				<div class="pergunta py-2">
					<a class="lead" data-toggle="collapse" data-parent="#perguntasFrequentes2" href="#pergunta7" aria-expanded="true" aria-controls="pergunta7">Posso modificar as imagens e os créditos ?</a>
				...
				<div class="dropdown-divider"></div>
				<div class="pergunta py-2">
					<a class="lead" data-toggle="collapse" data-parent="#perguntasFrequentes2" href="#pergunta8" aria-expanded="true" aria-controls="pergunta8">Como devo compartilhar as notícias ?</a>
