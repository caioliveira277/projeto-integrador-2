<main class="terror bg-preto pb-5">
    <section class="container-xl px-0 px-lg-2">
        <div class="d-flex flex-column justify-content-center banner-postagem px-3">
            <em class="text-center m-auto">
                <h1 class="titulo-sombreado">JOGOS DE TERROR</h1>
                <h2 class="mt-4 subtitulo-opacidade">Apague a luz pegue a pipoca e tome cuidado com as portas</h2>
            </em>
            <div class="row justify-content-around mb-5 flex-column flex-md-row align-items-center align-items-md-center p-3 bg-botoes-navegacao">
                <a href="./index.php?view=rpg" class="btn btn-outline-primary rounded-pill px-5 my-2 my-md-0 col-12 col-md-4 font-weight-bold w-customizado">RPG</a>    
                <a href="./index.php?view=acao-aventura" class="btn btn-outline-primary rounded-pill px-5 my-2 my-md-0 col-12 col-md-4 font-weight-bold w-customizado">AÇÃO</a>    
                <a href="./index.php?view=pixel" class="btn btn-outline-primary rounded-pill px-5 my-2 my-md-0 col-12 col-md-4 font-weight-bold w-customizado">PIXEL</a>    
            </div>
        </div>
